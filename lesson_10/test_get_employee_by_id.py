# lesson_10/test_get_employee_by_id.py
import requests
import allure
...
@allure.description("Тестирование получения сотрудника по его ID")
...
def test_get_employee_by_id():
    ...
    with allure.step("Получаем сотрудника по ID через API"):
